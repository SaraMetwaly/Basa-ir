...
class _QuranViewerScreenState extends ConsumerState<QuranViewerScreen> {
  ...
  final List<String> _dropDownOptions = ['فيديو','تفسير','بصائر','تصميم جرافيك'];
                                                ...
                                                onPressed: () {
                                                  showDialog(
                                                    ...
                                                    builder: (BuildContext context) {
                                                      String? uploadedFile; // Local variable for file name
                                                      return AlertDialog(
                                                          ...
                                                          builder: (context, setState) {
                                                            return Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                ElevatedButton.icon(
                                                                  onPressed: () async {
                                                                    FilePickerResult? fileChosed = await FilePicker.platform.pickFiles();
                                                                    if (fileChosed != null) {
                                                                      setState(() {
                                                                        uploadedFile = fileChosed.files.single.name;
                                                                      });}
                                                                  },
